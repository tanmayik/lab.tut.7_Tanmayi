...
expName = 'lab-tut.7'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/tanmayikalapatapu/Desktop/lab-tut.7_lastrun.py',
...
polygon = visual.ShapeStim(
    ...
    size=(0.2, 0.2), vertices='circle',
    ori=0.0, pos=(0, 0), anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor=[1.0000, -0.0039, -0.3725], fillColor=[1.0000, -0.0039, -0.3725],
...
text = visual.TextStim(win=win, name='text',
    text='Report the delay between the key press and the sound (on a scale of 0-999)\nClick submit after entering value',
    font='Open Sans',
...
trials = data.TrialHandler(nReps=5.0, method='random', 
    ...
    trialList=data.importConditions('/Users/tanmayikalapatapu/Downloads/lab.tut.7_data - Sheet1.csv'),
